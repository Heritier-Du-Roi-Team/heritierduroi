...
static const float COLORMAP_OVERLAY_STRENGTH 	= 0.8f; //0.75f;
...
// CAMERA_MIN_HEIGHT = 100.0,					defines.lua   (reload defines)
// CAMERA_MAX_HEIGHT = 3500.0,					defines.lua   (reload defines)
...
static const float GB_STRENGTH_CH2 = 0.3; // Opacity of top layer
